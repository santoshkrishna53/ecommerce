...
let AppComponent = class AppComponent {
    ...
    get_products() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let result = yield this.http.post(this.configUrl, {}).subscribe(data => { console.log("check"); console.log(data); return data; }, error => { console.log("Error", error); });
...
/* harmony import */ var _angular_material_badge__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/material/badge */ "./node_modules/@angular/material/esm2015/badge.js");
...
let CartComponent = class CartComponent {
    constructor(share, userservice, _snackBar) {
        this.share = share;
...
let ProductsComponent = class ProductsComponent {
    constructor(httpClient, share, UserService) {
    ...
    addtokart(pp) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.UserService.updateproductquantity(product);
            yield this.UserService.updatekart(this.kart[0]);
        });
    }
    test(data) {
...
let RegisterComponent = class RegisterComponent {
    constructor(userservice, _snackBar) {
        this.userservice = userservice;
        this._snackBar = _snackBar;
    ...
    signup() {
        if (this.registerForm.valid) {
            this.userservice.register(JSON.stringify(this.registerForm.value))
                .subscribe(data => { this._snackBar.open('Account created successfully', '', { duration: 3000 }); }, error => { this._snackBar.open(error, '', { duration: 3000 }); });
        }
        else {
...
let UserService = class UserService {
    constructor(SharedDataService, http, _snackBar, router) {
    ...
    login(body) {
        this.http.post("http://localhost:4000/auth/login", body, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('content-Type', 'application/json'), withCredentials: true }).subscribe(data => {
            if (data) {
                ...
                this._snackBar.open('Successfully logined', '', {
                    duration: 3000
                });
            }
        }, error => {
    ...
    update_password(data) {
        this.http.post("http://localhost:4000/auth/UpdatePassword", data, { headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append('content-Type', 'application/json'), withCredentials: true }).subscribe(data => {
            ...
            this.profile();
            this._snackBar.open('PLease enter rigth old password', '', {
                duration: 3000
            });
        });
        this.logout();
